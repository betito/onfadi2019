...
<blockquote style="text-align:  center; font-style: italic;"><strong>DIVISÃO DE ADMINISTRA&ccedil;&atilde;O</strong></blockquote>
...
while($row2 = mysql_fetch_assoc($rs2)) {
        ...
        $tipo = $row2["tipo"];
             if ($sigla == "DIAD" and $tipo == "Chefia Imediata" and $row2["subordinacao"] == "nenhuma" ) {
...
echo '</tr>';
 ...
 while($row1 = mysql_fetch_assoc($rs1)) {
        ...
        $sit = $row1["Situacao"];
                ...
                if ($sigla == "DIAD" OR $sub == "DIAD" and $sit =="Ativo") {
                if ($nome <> "Luiz Carlos de Pereira da Silva") {
...
echo '</table>';
  ...
  // while($row1 = mysql_fetch_assoc($rs1)) {
   ...
   //     $sigla = $row1["sigla_org"];
    //    $tipo = $row1["tipo"];
           //  if ($sigla == "DIAD" and $tipo <> "Chefia Imediata" ) {
