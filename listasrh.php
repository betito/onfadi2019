...
<blockquote style="text-align:  center; font-style: italic;"><strong>SERVIÇO DE RECURSOS HUMANOS</strong></blockquote>
...
while($row2 = mysql_fetch_assoc($rs2)) {
        ...
        $tipo = $row2["tipo"];
          if ($sigla == "SRH" and $tipo == "Chefia Imediata") {
...
echo '</tr>';
    ...
    while($row1 = mysql_fetch_assoc($rs1)) {
        ...
        $tipo = $row1["tipo"];
        $sit = $row1["Situacao"];
             if ($sigla == "SRH" and $tipo <> "Chefia Imediata" and $sit == "Ativo") {
