...
<center>
      ...
      echo '<blockquote style="text-align:  center; font-style: italic;"><strong>'.$nm. 'DIRETORIA</strong></blockquote>';
...
while($row2 = mysql_fetch_assoc($rs2)) {
        ...
        $tipo = $row2["tipo"];
             if ($sigla == "DIR" and $tipo == "Chefia Imediata") {
...
if ($sigla == "DIR" and $tipo == "Chefia Imediata ESP") {
            echo ' <blockquote style="text-align:  center; font-style: italic;"> Chefia Imediata: <a href="login.php?lin='.$row2["nome"].'">' .$row2["nome"]. '</a></blockquote>';
}
}
...
echo '</tr>';
    ...
    while($row1 = mysql_fetch_assoc($rs1)) {
        ...
        $tipo = $row1["tipo"];
        $sit = $row1["Situacao"];
             if ($sigla == "DIR" and $tipo <> "Chefia Imediata" and $sit =="Ativo") {
