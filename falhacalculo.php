...
<div class="container">
    ...
    <div id="content">
        ...
        <center>
            ...
            <h1 class="sucesso"><br><font color="red">Desculpe, faltou algum ítem para ser avaliado, <br>por favor retorne e faça uma revisão em sua avalia&ccedil;&atilde;o.<br> </font></h1><br>
    ...
    <footer id="rodape">
        ...
        <div style="float: right; margin-right: 40px;">
           <a href='javascript:window.history.go(-2)' style="text-transform: uppercase; color: red; text-shadow: 1px 1px 3px rgba(0,0,0,.3);"> SAIR</a></center><br><br><br>"
        </div>
    </footer>
</div>
