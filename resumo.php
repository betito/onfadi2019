        ...
        <table style="width: 790px; margin-left: -90px;" class="tabela-mod center" >
            ...
            <BR><BR>
                <table border="1" style="text-align:center;">
                 ...
                 <tr>
                 <td style="font-size: 12pt; text-align:center;"> 3 pts </td>
                 <td style="font-size: 12pt; text-align:center;"> 7 pts </td>
                 <td style="font-size: 12pt; text-align:center;"> 11 pts </td>
                 <td style="font-size: 12pt; text-align:center;"> 15 pts </td>
                 </tr>
          ...
          <br>
         <p style="font-size: 12pt; font-weight: bold; text-align:center;"> ________________________________________<br><br> Assinatura do Servidor <br><br> AM _______ /______/_______</p><br><br>

         <center> <a href="#" onClick="window.print();">[Imprimir Dados]</a><center><br><br>
