...
<div class="container">
    ...
    <div class="conteudo">
        ...
        <h1 class="nome" style="width: 325px;">Lista de Servidores</h1>
                 ...
                 <br> <h2 class="center" style="text-transform: uppercase;">Coordena&ccedil;&atilde;o de Geofísica</h2>


        <hr style="width: 300px; margin: auto; display: block;" color="#0c3068" size="2" noshade="noshade"/>

<blockquote style="text-align:  center; font-style: italic;"><strong>Chefia Imediata:</strong> Andrés Reinaldo Rodrigues Papa</blockquote>
      ...
      mysql_set_charset('UTF8', $conexao);
        $strSQL = "SELECT * FROM avaliado where sigla_org = 'COGE'" ;
    ...
    // grupo 5
      echo '<br><span class="topic"> Grupo 5</span><hr/><br>';
     ...
     // grupo 6
      echo '<br><span class="topic"> Grupo 6</span><hr/><br>';
      while($row1 = mysql_fetch_assoc($rs6)) {
      $grupo =  $row1['grupo'];
             if ($grupo == "6" ) {
                       echo '<!a href="tabela_avaliacao.php?lin='.$row1["nome"].'">' .$row1["nome"]. '</a><br>';
            }
    ...
    // grupo 7
      echo '<br><span class="topic"> Grupo 7</span><hr/><br>';
      while($row1 = mysql_fetch_assoc($rs7)) {
      $grupo =  $row1['grupo'];
             if ($grupo == "7" ) {
                       echo '<!a href="tabela_avaliacao.php?lin='.$row1["nome"].'">' .$row1["nome"]. '</a><br>';
            }
     ...
     // grupo 8
      echo '<br><span class="topic"> Grupo 8</span><hr/><br>';
      while($row1 = mysql_fetch_assoc($rs8)) {
      $grupo =  $row1['grupo'];
             if ($grupo == "8" and $row1["Situacao"] <> "Impedido") {
                       echo '<!a href="tabela_avaliacao.php?lin='.$row1["nome"].'">' .$row1["nome"]. '</a><br>';
            }
    }
