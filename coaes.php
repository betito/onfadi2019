...
<div class="container">
    ...
    <div class="conteudo">
       ...
       <br>
                 ...
                 <br> <h2 class="center" style="text-transform: uppercase;">Coordena&ccedil;&atilde;o de Astronomia</h2>


        <hr style="width: 300px; margin: auto; display: block;" color="#0c3068" size="2" noshade="noshade"/>

<blockquote style="text-align:  center; font-style: italic;"><strong>Chefia Imediata:</strong> Jaílson Souza de Alcaniz</blockquote>
      ...
      mysql_set_charset('UTF8', $conexao);
        $strSQL = "SELECT * FROM avaliado where sigla_org = 'COAA'" ;
