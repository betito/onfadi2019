...
<div class="container">
    ...
    <div class="conteudo">
        ...
        <h1 class="nome" style="width: 325px;">Lista de Servidores</h1>
                 ...
                 <br> <h2 class="center" style="text-transform: uppercase;">Serviço de Material e Patrimônio</h2>


        <hr style="width: 300px; margin: auto; display: block;" color="#0c3068" size="2" noshade="noshade"/>

<blockquote style="text-align:  center; font-style: italic;"><strong>Chefia Imediata:</strong> Luciano Alberto Vieira da Silva</blockquote>
      ...
      mysql_set_charset('UTF8', $conexao);
        $strSQL = "SELECT * FROM avaliado where sigla_org = 'SMP'" ;
