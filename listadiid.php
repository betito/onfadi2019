...
<blockquote style="text-align:  center; font-style: italic;"><strong>DIVISÃO DE DOCUMENTA&ccedil;&atilde;O</strong></blockquote>
...
while($row2 = mysql_fetch_assoc($rs2)) {
        ...
        $tipo = $row2["tipo"];
             if ($sigla == "DIID" and $tipo == "Chefia Imediata") {
...
echo '</tr>';
    ...
    while($row1 = mysql_fetch_assoc($rs1)) {
        ...
        $tipo = $row1["tipo"];
        $sit = $row1["Situacao"];
         if ($sigla == "DIID" and $tipo <> "Chefia Imediata" and $sit =="Ativo") {
