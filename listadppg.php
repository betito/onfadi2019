...
<blockquote style="text-align:  center; font-style: italic;"><strong>DIVISÃO DE PÓS-GRADUA&ccedil;&atilde;O</strong></blockquote>
...
while($row2 = mysql_fetch_assoc($rs2)) {
        ...
        $tipo = $row2["tipo"];
             if ($sigla == "DPPG" and $tipo == "Chefia Imediata") {
...
echo '</tr>';
    ...
    while($row1 = mysql_fetch_assoc($rs1)) {
        ...
        $tipo = $row1["tipo"];
        $sit = $row1["Situacao"];
             if ($sigla == "DPPG" and $tipo <> "Chefia Imediata" and $sit =="Ativo") {
