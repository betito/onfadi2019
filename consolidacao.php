...
<div class="container">
    ...
    <div class="conteudo">
        ...
        <h1 class="nome" style="width: 325px;">Lista de Servidores</h1>
                 ...
                 <h2 class="center" style="text-transform: uppercase;">&Aacute;rea de Visualiza&ccedil;&atilde;o da consolida&ccedil;&otilde;es por Servidor </h2>
                 

        <hr style="width: 300px; margin: auto; display: block;" color="#0c3068" size="2" noshade="noshade"/>

        <br><a href="painelrh.php">
            <span class="botao">
                VOLTAR
            </span>
        </a>
