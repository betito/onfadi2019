...
<center>
      ...
      echo '<blockquote style="text-align:  center; font-style: italic;"><strong>'.$nm. 'SERVIÇO FINANCEIRO</strong></blockquote>';
...
while($row2 = mysql_fetch_assoc($rs2)) {
        ...
        $tipo = $row2["tipo"];
             if ($sigla == "SEF" and $tipo == "Chefia Imediata") {
...
if ($sigla == "SEF" and $tipo == "Chefia Imediata ESP") {
            echo ' <blockquote style="text-align:  center; font-style: italic;"> Chefia Imediata: <a href="login.php?lin='.$row2["nome"].'">' .$row2["nome"]. '</a></blockquote>';
}
}
...
echo '</tr>';
    ...
    while($row1 = mysql_fetch_assoc($rs1)) {
        ...
        $sit = $row1["Situacao"];
             ...
             if ($sigla == "SEF" and $tipo <> "Chefia Imediata" and $tipo <> "Chefia Imediata ESP" and $vis == "1" and $sit =="Ativo") {
