...
<blockquote style="text-align:  center; font-style: italic;"><strong>DIVISÃO DE SERVIÇO DA HORA</strong></blockquote>
...
while($row2 = mysql_fetch_assoc($rs2)) {
        ...
        $tipo = $row2["tipo"];
             if ($sigla == "DSHO" and $tipo == "Chefia Imediata") {
...
echo '</tr>';
    ...
    while($row1 = mysql_fetch_assoc($rs1)) {
        ...
        $sit = $row1["Situacao"];
             ...
             if ($sigla == "DSHO" and $tipo <> "Chefia Imediata" and $sit =="Ativo") {
