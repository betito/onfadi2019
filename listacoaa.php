...
<blockquote style="text-align:  center; font-style: italic;"><strong>COORDENA&ccedil;&atilde;O DE ASTRONOMIA</strong></blockquote>
...
while($row2 = mysql_fetch_assoc($rs2)) {
        ...
        $tipo = $row2["tipo"];
             if ($sigla == "COAA" and $tipo == "Chefia Imediata") {
...
echo '</tr>';
    ...
    while($row1 = mysql_fetch_assoc($rs1)) {
        ...
        $sit = $row1["Situacao"];
             ...
             if ($sigla == "COAA" and $tipo <> "Chefia Imediata" and $sit =="Ativo") {
