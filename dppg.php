...
<div class="container">
    ...
    <div class="conteudo">
        ...
        <h1 class="nome" style="width: 325px;">Lista de Servidores</h1>
                 ...
                 <br> <h2 class="center" style="text-transform: uppercase;">Divisão de Pós-Gradua&ccedil;&atilde;o </h2>


        <hr style="width: 300px; margin: auto; display: block;" color="#0c3068" size="2" noshade="noshade"/>

<blockquote style="text-align:  center; font-style: italic;"><strong>Chefia Imediata:</strong> Valeria Cristina Ferreira Barbosa</blockquote>
      ...
      mysql_set_charset('UTF8', $conexao);
        $strSQL = "SELECT * FROM avaliado where sigla_org = 'DPPG'" ;
    ...
    // grupo 1
      echo '<br><span class="topic"> Sem Membros</span><hr/><br>';
      while($row1 = mysql_fetch_assoc($rs1)) {
      $grupo =  $row1['grupo'];
             if ($grupo == "1" or $grupo == "Sem Membros") {
