...
<blockquote style="text-align:  center; font-style: italic;"><strong>COORDENA&ccedil;&atilde;O DE ADMINISTRA&ccedil;&atilde;O</strong></blockquote>
...
while($row2 = mysql_fetch_assoc($rs2)) {
        ...
        $tipo = $row2["tipo"];
             if ($sigla == "COAD" and $tipo == "Chefia Imediata") {
 ...
 if ($sigla == "COAD" and $tipo == "Chefia Imediata ESP") {
            echo ' <blockquote style="text-align:  center; font-style: italic;"> Chefia Imediata: <a href="login.php?lin='.$row2["nome"].'">' .$row2["nome"]. '</a></blockquote>';
}
}
...
echo '</tr>';
    ...
    while($row1 = mysql_fetch_assoc($rs1)) {
        ...
        $nome = $row1["nome"];
             if ($sigla == "COAD" OR $sub == "COAD") {
                if ($nome <> "José Ricardo Silva de Oliveira") {
