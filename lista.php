...
<div class="container">
    ...
    <div class="conteudo">
        ...
        <blockquote style="text-align:  center; font-style: italic; color:red;">Basta clicar no nome do servidor para modificar grupo</blockquote>
...
<br>
      <?php
    // Conecta com o Banco de Dados
    $conexao = mysql_connect("192.168.1.141", "webdtin", "on2013") or die (mysql_error ());
...
echo '</tr>';
  ...
  // Loop pelo recordset $rs
    while($row2 = mysql_fetch_assoc($rs2)) {
        ...
        $tipo = $row2["tipo"];
        $sit = $row2["Situacao"];
        if ($tipo == "Chefia Imediata" and $sit == "Ativo") {
echo '<tr>';
